...
```sh
# for cmake installation via pip3
sudo apt install python3-venv python3-pip
python3 -m venv __venv  
source __venv/bin/activate
./__venv/bin/pip3 install cmake

# for the library
sudo apt install libpugixml-dev pkgconf libwayland-dev mesa-common-dev libegl-dev
...
```sh
# library + examples
./__venv/bin/cmake -S . -B ./__build -DBUILD_LIBRARIES=ON -DBUILD_EXAMPLES=ON -DBUILD_DOCUMENTATION=OFF -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_INSTALL_PREFIX=./__bin
./__venv/bin/cmake --build ./__build --target install -j8
# and then start examples in directory:
# ./__bin/examples

# documentation
./__venv/bin/cmake -S . -B ./__build -DBUILD_LIBRARIES=OFF -DBUILD_EXAMPLES=OFF -DBUILD_DOCUMENTATION=ON -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_INSTALL_PREFIX=./__bin
./__venv/bin/cmake --build ./__build --target install -j8
# and then look at documentation in directory 
# ./__bin/share/doc/waylandpp/html
```
